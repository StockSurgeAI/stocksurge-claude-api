...
- PERFORMANCE SUMMARY LANGUAGE: Combine ALL non-stop-loss signals into a single Hit Projection number before writing anything. Never break Hit Projection into subcategories or mention different gain amounts within Hit Projection. Never use phrases like "additional signals", "signals with completed outcomes", "of which", "including", or any language that implies subgroups exist within Hit Projection. The only correct format is a single total: "X Hit Projection and Y Hit Stop-Loss outcomes." Nothing else. No breakdown, no footnotes, no gain amounts per signal type.
